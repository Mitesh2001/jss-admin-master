@extends('captain.layouts.app', ['page' => ''])
        ...
        <div class="card">
            ...
            <div class="card-body p-3">
                ...
                @if($user->google2fa_secret)
                    <form method="post"
                        class="text-center"
                        action="{{ route('captain.disabled_google_two_factor') }}"
                    >
                        @csrf
                ...
                @else
                    <div class="text-center">
                        ...
                        <div id="google-two-factor" class="d-none">
                            <form method="post" action="{{ route('captain.verify_google_two_factor') }}">
                                @csrf
...
<div class="card">
    ...
    <div class="card-body p-3">
        <form method="post" action="{{ route('captain.password_update') }}">
            @csrf
...
@push('scripts')
    <script>
        $('#two-factor-auth-button').click(function () {
            ...
            axios.get("{{ route('captain.google_two_factor') }}")
